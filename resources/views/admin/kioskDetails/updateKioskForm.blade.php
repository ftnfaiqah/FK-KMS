...
<div class="container-fluid">
    ...
    <div  class="tabcontent">
        <form role="form" method="POST"  action="{{ route('kiosk.updateKiosk', ['kiosk' => $data->kiosk_ID]) }}"  enctype="multipart/form-data">
            @csrf 
            <div class="container mt-2">
                ...
                <div class="right">
                    <input class="form-control" type="text" id="" name="kiosk_name" value={{ $data->kiosk_name ?? '-' }} >
                </div>
            </div>
            ...
            <div class="container mt-2">
                ...
                <div class="right">
                    <input class="form-control" type="text" id="" name="kiosk_location" value={{ $data->kiosk_location ?? '-' }}>
                </div>
            </div>
            ...
            <div class="container mt-2">
                ...
                <div class="right">
                    <input class="form-control" type="text" id="" name="kiosk_size" value={{ $data->kiosk_size ?? '-' }}>
                </div>
            </div>
            ...
            <div class="container mt-2">
                ...
                <div class="right">
                    <input class="form-control" type="text" id="" name="kiosk_rent" value={{ $data->kiosk_rent ?? '-' }}>
                </div>
            </div>
            ...
            <div class="container mt-2">
                ...
                <div class="right">
                    <input class="form-control" type="text" id="" name="kiosk_status" value="{{ $data->kiosk_status ?? '-' }}" disabled>
                </div>
            </div>
